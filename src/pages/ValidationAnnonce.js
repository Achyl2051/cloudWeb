...
function ValidationAnnonce() {
  ...
  const loadCommission = async () => {
    const result = await axios.get("http://cloudwebservice-production-7ad7.up.railway.app/commissions/1", {
      headers: {
  ...
  const loadAnnonceNonValide = async () => {
    const result = await axios.get("http://cloudwebservice-production-7ad7.up.railway.app/annonces/nonvalide", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  const handleValidation = async (idAnnonce) => {
    const url = `http://cloudwebservice-production-7ad7.up.railway.app/annonces/validate?idAnnonce=${idAnnonce}&commission=${commissionValue.valeur}`;
