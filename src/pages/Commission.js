...
function Commission() {
    ...
    const loadCommission =async ()=>{
        const result=await axios.get("http://cloudwebservice-production-7ad7.up.railway.app/commissions", {
            headers: {
    ...
    const loadCaisse =async ()=>{
        const result=await axios.get("http://cloudwebservice-production-7ad7.up.railway.app/venteannonce/commission", {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        });
    ...
    const onInputChange = (e) => {
      ...
      const onSubmit = async (e) => {
        ...
        try {
            await axios.put("http://cloudwebservice-production-7ad7.up.railway.app/commissions/1", formData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
